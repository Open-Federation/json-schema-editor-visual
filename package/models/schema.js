...
export default {
  ...
  loadRefFieldsAction: function (state, action, oldState) {
    const keys = action.key
    let oldData = oldState.data
    let newPropertiesData = {}
    ...
    console.log(
      newPropertiesData,
      'newPropertiesDatanewPropertiesDatanewPropertiesDatanewPropertiesData'
    )
    utils.loadRef(state.data, keys)
    ...
    let requiredData = [].concat(parentData.required || [])
    parentKeys.push('required')
    console.log({ oldData, action, parentKeys, newPropertiesData })
    console.log('{ state: state.data, action, parentKeys, newPropertiesData }')
    utils.setData(state.data, parentKeys, requiredData)
  },
